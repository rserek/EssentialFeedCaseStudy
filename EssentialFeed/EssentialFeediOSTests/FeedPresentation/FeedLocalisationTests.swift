...
class FeedLocalisationTests: XCTestCase {
    ...
    private func allLocalizationStringKeys(in bundles: [LocalizedBundle], table: String, file: StaticString = #file, line: UInt = #line) -> Set<String> {
